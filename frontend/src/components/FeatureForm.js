...
export default function FeatureForm({
  ...
  return (
    <form onSubmit={onSubmit} noValidate>
      ...
      <div className="card">
        ...
        <div className="form-group">
          ...
          <input
            ...
            onChange={onTopLevel}
            placeholder="Ej: IngresoClienteClaroPay"
            required
          />
        </div>
        <div className="form-group">
          <label>
            Endpoint base <span className="required">*</span>
          </label>
          <input
            className="form-control"
            type="text"
            ...
            value={form.endpoint}
            onChange={onTopLevel}
            placeholder="Ej: /v1/client/data"
            required
          />
        </div>
        <div className="method-note">
          💡 El método HTTP, los parámetros, headers y validaciones se configuran por escenario,
          así podés combinar cualquier operación dentro del mismo feature.
        </div>
      </div>
      ...
      <button
        type="button"
        className="btn btn--ghost btn--add-scenario"
